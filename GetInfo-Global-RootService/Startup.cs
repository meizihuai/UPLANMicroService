...
namespace GetInfo_Global_RootService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IQoEDeviceService, QoEDeviceService>();
            //允许跨域
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, IApplicationLifetime aft)
        {
            ...
            contentTypeProvider.Mappings.Add(".exe", "application/windows");
            contentTypeProvider.Mappings.Add(".apk", "application/android");
